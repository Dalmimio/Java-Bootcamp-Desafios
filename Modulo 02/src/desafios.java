...
public class desafios {
	...
	public static void main(String[] args) {
		...
		por consola dos n�meros y realice las siguientes 
		operaciones:
		1. El usuario debe poder ingresar la cantidad de 
		decimales que desea ver en el resultado.
		2. Sacar la potencia de los n�meros ingresados*/
		...
		1. Mostrar la representaci�n ASCII de las letras en 
